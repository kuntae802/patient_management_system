...
## Deferred from: code review of 7-8-수납-정책-후수납-선수납 (2026-06-24)

> 3레이어 적대적 리뷰(Blind·Edge·Auditor) 결과 patch 3(적용)·decision-needed 0·defer 3·dismiss 6. AC1~10 전부 SATISFIED·설계 결정 4건 준수. 아래는 7.9 스코프/기존 한계로 미룬 항목.
