...
const SENSITIVE_KEY =
  /(resident_no|rrn|ssn|password|passwd|secret|token|email|phone|address|guardian|allergies|chronic_diseases|medications|notes|insurance_no|subjective|objective|assessment|plan|allergy_override_reason|content|findings|reading_conclusion|_enc$|_hash$|_blind_index$|ciphertext)/i;
